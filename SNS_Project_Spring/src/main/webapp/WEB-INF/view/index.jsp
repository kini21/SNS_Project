...
<body>
		...
		<div class="container center-block">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li>
						...
						<div class="modal fade" id="profileModal" tabindex="-1" role="dialog" aria-labelledby="profileModalLabel" aria-hidden="true">
										...
										<div class="row">
											<div class="col-lg-12">
												...
												<form id="profile-form" action="#" method="post" role="form">
													...
													<!-- insert username -->
													<div class="form-group">
														<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="닉네임"
															value="">
													</div>
							...
							<!-- end of modal-dialog -->
						</div> <!-- end of modal fade & modal --></li>
				</ul>
				...
				<ul class="nav navbar-nav navbar-right">
					<li>
						<a href="#" style="font-weight: bold; color: white; text-shadow: 1px 1px 1px grey;">
				...
				<form class="navbar-form navbar-right">
					<button type="button" class="btn btn-info" data-toggle="modal" data-target="#writeModal"
						style="font-weight: bold; outline: none;">글 쓰기</button>
			...
			<div class="col-md-3">
					...
					<div class="sidebarProfile">
						...
						<div class="profileCardContent">
							...
							<div class="profileUseridAndNick">
								...
								<span class="userNick"> <a class="uN" href="#">purplecow</a>
								</span>
							</div>
				...
				<div class="sidebar2">
					<div class="list-group">
						<a href="#" class="list-group-item list-group-item-success" data-toggle="tooltip" data-placement="top" title="내가 쓴 글 2345개"> 내가 쓴 글 : 2345개 </a>
						<a href="#" class="list-group-item list-group-item-info" data-toggle="modal" data-target="#followModal" title="팔로잉 670명"> 팔로잉 : 670명 </a>
					</div>
												...
												<div class="col-md-12">
													<div class="content_header" style="display: flex;">
														<a href="#" style="margin-right: 5px;"> <img
															class="content_img"
															src="<c:url value='/common/img/circle.gif' />" /> <span
															class="nameGroup"> <strong class="uid">박호균</strong>
														</span> <span class="uname"> <b
																style="font-weight: normal">purplecow</b>
														</span>
														</a> <small class="time" data-toggle="tooltip"
															data-placement="top" title="오전 4:49 - 2017년 11월 24일">
															· 11월 24일 </small>
													</div>
												</div>
											</div>
												...
												<div class="col-md-12">
													...
													<a href="#" style="color: #000;">
														<div class="iconBox" data-toggle="modal" data-target="#subModal">
															...
															<!-- 본문 글 영역 -->
															<div>
																<p class="text_box">그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!!
																	그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고
																	블로그 켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그
																	켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그 켜라!!그림판
																	켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그 켜라!!그림판 켜고 블로그
																	켜라!!그림판 켜고 블로그 켜라!!</p>
															</div>
																	...
																	<div class="modal-body">
																		...
																		<div class="row">
																			...
																			<div class="content_header" style="display: flex;">
																				...
																				<small class="reply_time" data-toggle="tooltip" data-placement="top" title="오전 4:49 - 2017년 11월 24일"> · 11월 24일</small>
																			</div>
																			<div class="reply_text_box">
																				<p>그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!! 그림판 켜고 블로그
																					켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그
																					켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그
																					켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그
																					켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그
																					켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!</p>
																			</div>
												...
												<div class="col-md-12">
													...
													<div class="content_footer">
														<div class="button_list">
															<div class="reply_btn">
																<a href="#" class="btn2" data-toggle="tooltip"
																	data-placement="top" title="댓글달기">
																	...
																	<div class="modal-content">
																		...
																		<form id="reply-form" action="#" method="post"
																			...
																			<div class="modal-body">
																				...
																				<div class="row">
																					<div class="reply-row-textArea">
																						<textarea rows="44" name="status"
																							class="writeTextArea"></textarea>
																					</div>
																				</div>
																			</div>
																			<div class="modal-footer">
																				<button type="button" class="btn btn-default"
																					...
																					title="사진 또는 동영상 추가하기" style="float: left;">
																					<span class="glyphicon glyphicon-picture"></span>
																				</button>
																				<button type="button" class="btn btn-default"
																					data-dismiss="modal">취소</button>
															...
															<!-- 따봉 버튼 영역 -->
															<div class="ddabong"
																style="min-width: 26px; display: inline-block;">
																<a href="#" class="btn2" data-toggle="tooltip"
																	data-placement="top" title="따봉">
																	<div class="iconBox">
																		<span class="glyphicon glyphicon-thumbs-up"
																			aria-hidden="true"></span>
																	</div>
																</a> <span class="ddabongCnt"> 9452 </span>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="content" style="margin-left: 58px;">
											<div class="content_header" style="display: flex;">
												<a href="#" style="margin-right: 5px;"> <img
													...
													src='<c:url value="/common/img/circle.gif" />' /> <span
													class="nameGroup"> <strong class="uid">박호균</strong>
												</span> <span class="uname"> <b style="font-weight: normal">purplecow</b>
												</span>
												</a> <small class="time" data-toggle="tooltip"
													data-placement="top" title="오전 4:49 - 2017년 11월 24일">
													· 11월 24일 </small>
											...
											<!-- End of content_header -->
											<div>
												<p class="text_box">그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!! 그림판
													켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그
													켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그 켜라!!그림판 켜고
													블로그 켜라!!그림판 켜고 블로그 켜라!! 그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!그림판
													켜고 블로그 켜라!! 그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!그림판 켜고 블로그 켜라!!</p>
											</div>
											<div class="content_footer">
												<div class="button_list">
													<div class="reply_btn">
													...
													<div class="ddabong"
														...
														</a> <span class="ddabongCnt"> 4 </span>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="content_footer">
												<div class="button_list">
													...
													<div class="ddabong"
														...
														</a> <span class="ddabongCnt"> 2 </span>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="content_footer">
												<div class="button_list">
													...
													<div class="ddabong"
														...
														</a> <span class="ddabongCnt"> 0 </span>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="content" style="margin-left: 58px;">
											...
											<div class="imgBoxContainer">
												<div class="imgBox">
													<div class="soleImg">
														<div class="imgInnerContainer">
															<img src='<c:url value="/common/img/f029.png" />'
											...
											<div class="content_footer">
												<div class="button_list">
													...
													<div class="ddabong"
														...
														</a> <span class="ddabongCnt"> 5 </span>
													</div>
												</div>
											</div>
										</div>
						...
						<nav>
							<ul class="pager" style="margin-top: 30px;">
								...
								<li class="next" style="font-weight: bold;">
									<a href="#">
										다음 페이지 <span aria-hidden="true">&rarr;</span>
									</a>
								</li>
							</ul>
						</nav>
	...
	<footer class="footer" style="height: 95px; margin-top: 0px; position: absolute; left: 0px; width: 100%; background: black; opacity: 0.7;">
		<div class="container">
			<div class="bottom_copyright">
				<p class="text-muted">
					Copyright OOOOO.com. All Right Reserved.</br> Contact us,
					OOOOOOO@google.com
				</p>
			</div>
		</div>
	...
	<script src="<c:url value='/common/js/fileChoose.js' />"></script>
	<!-- file choose -->
	...
	<script>
		...
		function writePost() {
	        ...
	        for (var i = 0; i < files.length; i++) {
	    		...
	    		util.ajaxFileAction("<c:url value='/post/writePost.html' />", formData, result);	
		}
